...
<?php
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO mobiliario(descripcion,categoria_nombre,cantidad,estado,observaciones,Imagen_Img) VALUES(:descripcion,:categoria_nombre,:cantidad,:estado,:observaciones,:upic)');
			...
			if($stmt->execute())
			{
				...
				// echo '<script>window.location="'.base_url.'CAMOBILIARIO/index"</script>';
			}
			else
			{
