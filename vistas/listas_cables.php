...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/INVENTARIO-FRONTEND/Administrador/vistas/css/style.css">
...
<!-- También puede utilizar dropdowns en su barra de navegación. Los dropdowns requieren un elemento de ajuste para el 
	...
	<div class="contenedor-principal">
		<nav class="navbar navbar-expand-lg " style="background:#39A900;">
			<a href="http://localhost/INVENTARIO-FRONTEND/Administrador/index.php">
			<img src="/INVENTARIO-FRONTEND/Administrador/img/logosena.JPG">
			</a>
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item active">
						<div class="menunavegacion">
							...
							<a class="dropdown-item" href="../../vistas/Usuarios/registrar.php?vista=user_new">Nuevo</a>
							<a class="dropdown-item" href="../../vistas/Usuarios/listas.php?vista=user_list">Lista</a>
							</div>
						</div>
					</li>
	...
	<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
		...
		<button class="btn btn-outline-info" type="submit" name="enviar">Buscar</button>
				...
				<a href="listas.php"> <button class="btn btn-outline-info" type="submit" name="">Mostrar todos los datos</button></a>
							<a href="registrar_cables.php" <button type="button" class="btn btn-secondary" style=" margin-top:-5px; margin-right:100px; ">Añadir </a></button>
